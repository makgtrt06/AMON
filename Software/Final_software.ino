...
void setup()
{
    ...
    altitudBase = altitudBase + 100; // This line is to start the program once the altitude is 100m higher than the initial; remove this part and the following while to jump directly to the loop.
